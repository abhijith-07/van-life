...
export function makeServer({ environment = "test" } = {}) {
  let server = createServer({
    ...
    seeds(server) {
      server.create("van", { id: "1", name: "Modest Explorer", price: 1600, description: "The Modest Explorer is a van designed to get you out of the house and into nature. This beauty is equipped with solar panels, a composting toilet, a water tank and kitchenette. The idea is that you can pack up your home and escape for a weekend or even longer!", url: "/images/van-images/van1.jpg", type: "simple" })
      server.create("van", { id: "2", name: "Beach Bum", price: 1800, description: "Beach Bum is a van inspired by surfers and travelers. It was created to be a portable home away from home, but with some cool features in it you won't find in an ordinary camper.", url: "/images/van-images/van2.jpg", type: "rugged" })
      ...
      server.create("van", { id: "5", name: "The Cruiser", price: 1120, description: "The Cruiser is a van for those who love to travel in comfort and luxury. With its many windows, spacious interior and ample storage space, the Cruiser offers a beautiful view wherever you go.", url: "/images/van-images/van5.jpg", type: "luxury" })
