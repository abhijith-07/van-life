...
export function makeServer({ environment = "test" } = {}) {
  let server = createServer({
    ...
    seeds(server) {
      ...
      server.create("van", { id: "2", name: "Beach Bum", price: 1800, description: "Beach Bum is a van inspired by surfers and travelers. It was created to be a portable home away from home, but with some cool features in it you won't find in an ordinary camper.", imageUrl: "https://assets.scrimba.com/advanced-react/react-router/beach-bum.png", type: "rugged" })
